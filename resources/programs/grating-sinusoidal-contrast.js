        ...
        for (let colorPair of colors) {
            for (let duration of durations) {
                for (let i = 0; i < repetitions; i++) {
                    ...
                    id = r.uuid()
                    left = new SinusoidalGrating(duration,colorPair[0], speed, size, angle, colorPair[1],
                    ...
                    right = new SinusoidalGrating(duration,colorPair[0], speed, size, inverseAngle(angle), colorPair[1],
